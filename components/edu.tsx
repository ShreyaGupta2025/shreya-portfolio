...
const edu = [
  ...
  },
  {
    ...
    subtitle:
      "B.E. – Electrical & Electronics Engineering ( Minor in Computing and Intelligence )",
    badge: "Undergraduate",
    description:
...
export default function Education() {
  ...
  return (
    <section id="education" className="py-24 px-4 sm:px-6 md:px-10 bg-background">
